...
import {IPermit2Minimal} from "./IPermit2Minimal.sol";
import {IStableSwapMinimal} from "./IStableSwapMinimal.sol";
...
contract CurvyPuppetLending is ReentrancyGuard {
    ...
    IStableSwapMinimal public immutable curvePool;
    ...
    constructor(address _collateralAsset, IStableSwapMinimal _curvePool, IPermit2Minimal _permit2, CurvyPuppetOracle _oracle) {
