...
// Local training fixture modelling Ethernaut 2025 "MagicAnimalCarousel".
// The bug: changeAnimal() lets anyone overwrite an initialized crate that
// has owner == 0 (constructor initializes crate 0 with owner 0).
